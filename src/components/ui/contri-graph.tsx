...
const THEME = cn(
  ...
  'hover:data-[level="0"]:fill-level-0',
  'hover:data-[level="1"]:fill-level-1',
  'hover:data-[level="2"]:fill-level-2',
  'hover:data-[level="3"]:fill-level-3',
  'hover:data-[level="4"]:fill-level-4',
);
...
export const ContributionGraphBlock = ({
  ...
  const level = Math.max(0, Math.min(activity.level, maxLevel));
...
export const ContributionGraphFooter = ({
  ...
  <div
    className={cn(
      "flex flex-wrap items-center gap-1.5 sm:whitespace-nowrap sm:gap-x-4",
      className,
    )}
    {...props}
  />
